...
def common_acknowledged(request: FixtureRequest):
    ...
    candidate_names = (
        'command_response','speed_response','stop_response','clamp_response',
        'up_response','home_response','angle_response',
        'red_response','brightness_response','reset_response',
        'auto_response','track_response','connect_response','info_response'
    )
    resp = None
